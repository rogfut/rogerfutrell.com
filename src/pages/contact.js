    ...
    return (
        <Layout>
            <div className={contactStyles.main}>
                {/* <h1>Contact</h1> */}
                <h3>You can find me on <a href="https://www.linkedin.com/in/rogerfutrell" className={contactStyles.links}>LinkedIn</a> or email me at <a href="mailto: rfut@outlook.com" className={contactStyles.links}>rfut@outlook.com</a></h3>
